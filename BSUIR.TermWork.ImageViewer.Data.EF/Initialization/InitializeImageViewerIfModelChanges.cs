...
{
    internal sealed class InitializeImageViewerIfModelChanges : DropCreateDatabaseIfModelChanges<ImageViewerContext>
    {
        #region Overrides of DropCreateDatabaseIfModelChanges<ImageViewerContext>
